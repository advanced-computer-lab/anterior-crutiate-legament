...
function SideNavLink (props) {
     ...
     return (
        <>    
            <Paper elevation={2} style={{margin:"7%",marginTop:"12%" , padding:"2%",paddingBottom:"10%"}}>
            
            <Grid container>
                <Link href = "/" >
                <Paper elevation={3} elevation={1} style={{padding:10 ,marginTop:"5%",marginLeft:"10%",marginRight:"10%", width:"20%",float:"left"}}>
