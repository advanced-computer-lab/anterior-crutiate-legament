    ...
    return (
        ...
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y" id="sidenav-main">
            ...
            <div className="sidenav-header">
                ...
                <span class="ms-1 font-weight-bold">GUC Air</span>
                </a>
            </div>


            <hr className="horizontal dark mt-0"/>
            <div className="collapse navbar-collapse w-auto max-height-vh-100 h-100 ps ps--active-y" id="sidenav-collapse-main">
            ...
            <div className="ps__rail-x" styles="left: 0px; bottom: 0px;"><div className="ps__thumb-x" tabindex="0" styles="left: 0px; width: 0px;"></div></div><div className="ps__rail-y" styles="top: 0px; height: 327px; right: 0px;"><div className="ps__thumb-y" tabindex="0" styles="top: 0px; height: 220px;"></div></div></div>
            <div className="sidenav-footer mx-3 ">
            <div className="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                <div className="full-background" styles="background-image: url('../assets/img/curved-images/white-curved.jpeg')"></div>
        ...
        <div className="ps__rail-x" styles="left: 0px; bottom: 0px;"><div className="ps__thumb-x" tabindex="0" styles="left: 0px; width: 0px;"></div></div><div className="ps__rail-y" styles="top: 0px; height: 327px; right: 0px;"><div className="ps__thumb-y" tabindex="0" styles="top: 0px; height: 159px;"></div></div></aside>
    );
}
