...
class AddFlight extends React.Component {
  ...
  onSubmit(e) {
    ...
    if (
      ...
      dataCorrect = false;
    if (flightData.flight_number == "") dataCorrect = false;
    if (flightData.from == "") dataCorrect = false;
    if (flightData.to == "") dataCorrect = false;
    if (flightData.departure_time == "") dataCorrect = false;
    if (flightData.arrival_time == "") dataCorrect = false;
    if (!dataCorrect) {
    ...
    return (
      <div>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          />
          <br />
          <button className="add-flight-input" type="submit">
            Add Flight
          </button>
        </form>
